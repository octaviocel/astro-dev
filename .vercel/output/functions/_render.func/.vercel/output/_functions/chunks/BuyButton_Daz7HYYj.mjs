import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent, b as createAstro } from './astro/server_BoAgVVHb.mjs';
...
}, "C:/Users/octac/OneDrive/Escritorio/CURSOS/astro/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const MEXICO = "MX";
  const country = Astro2.request.headers.get("X-Vercel-IP-Country") ?? "MX";
  const storeCountry = country === MEXICO ? "mexico" : "usa";
  const countryName = country === MEXICO ? "M\xE9xico" : "Estados Unidos";
...
}, "C:/Users/octac/OneDrive/Escritorio/CURSOS/astro/dev-books/src/components/BuyButton.astro", void 0);

const $$file = "C:/Users/octac/OneDrive/Escritorio/CURSOS/astro/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
