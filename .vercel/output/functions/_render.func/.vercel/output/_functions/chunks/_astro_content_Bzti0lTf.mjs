...
import { c as createComponent, r as renderTemplate, u as unescapeHTML, A as AstroError, U as UnknownContentCollectionError, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, a as renderComponent } from './astro/server_BoAgVVHb.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BiVqq9HT.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./assets_BwNa1IAe.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DF3bbPPm.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./modules_DKjajEJ1.mjs');
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/books/aquiles-song.md": () => import('./aquiles-song_C18XMbdO.mjs'),"/src/content/books/learning-git.md": () => import('./learning-git_By6GrMKQ.mjs'),"/src/content/books/not-in-love.md": () => import('./not-in-love_BbTY3-BZ.mjs'),"/src/content/books/pilots-handbook.md": () => import('./pilots-handbook_Df3FI5ye.mjs')});
...
let lookupMap = {};
lookupMap = {"books":{"type":"content","entries":{"aquiles-song":"/src/content/books/aquiles-song.md","learning-git":"/src/content/books/learning-git.md","not-in-love":"/src/content/books/not-in-love.md","pilots-handbook":"/src/content/books/pilots-handbook.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/books/aquiles-song.md": () => import('./aquiles-song_DSQl9aV4.mjs'),"/src/content/books/learning-git.md": () => import('./learning-git_DMxkmvyr.mjs'),"/src/content/books/not-in-love.md": () => import('./not-in-love_BaV8OtEf.mjs'),"/src/content/books/pilots-handbook.md": () => import('./pilots-handbook_BkKEh3eg.mjs')});
